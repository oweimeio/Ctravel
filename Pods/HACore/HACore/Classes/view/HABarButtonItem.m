...
#import "HABarButtonItem.h"

@interface HABarButtonItem () {
	HABarButtonItemActionBlock actionCustom;
}
...
@implementation HABarButtonItem
...
- (instancetype)initWithImage:(UIImage *)icon andAction:(HABarButtonItemActionBlock)actionblock {
	...
	[customButton setBackgroundImage:icon forState:UIControlStateNormal];
